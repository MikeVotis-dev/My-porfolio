  ...
  const translations = {
    en: {
      ...
      content: {
        ...
        '#hero p': `I'm <span class="typed" data-typed-items="Student,Developer,Websites Builder,Designer,Editor">Designer</span>`,
        ...
        '.about-subtitle': `<span class="highlight-gold">Web developer</span> &amp; <span class="highlight-blue">Student</span>`,
        ...
        '#resume .resume-box h2': `Resume`,
        '#resume .resume-box p:nth-of-type(1)': `Hi! I'm <strong>Michail Votis</strong>, and I'm <strong>12 years old</strong>. I have loved <span class="highlight-blue">robotics</span> and <span class="highlight-gold">programming</span> since I was 7 years old, and since then I have been trying to learn new things all the time.`,
        '#resume .resume-box p:nth-of-type(2)': `I created a small <strong>YouTube channel</strong>, which I continue to develop step by step. I really enjoy programming and web development, and my dream is to become a <span class="highlight-blue">programmer</span>.`,
        '#resume .resume-box p:nth-of-type(3)': `I am learning languages like <span class="highlight-gold">HTML</span>, <span class="highlight-blue">CSS</span>, JavaScript, Python, C++, and Java, while also experimenting with creative tools like <strong>DaVinci Resolve</strong>, <strong>Photoshop</strong>, and <strong>Canva</strong>.`,
        '#resume .resume-box p:nth-of-type(4)': `I am always trying to improve, create new projects, and share my ideas with others.`,
    ...
    el: {
      ...
      content: {
        ...
        '#hero p': `Είμαι <span class="typed" data-typed-items="Student,Προγραμματιστής,Websites Builder,Designer,Editor">Designer</span>`,
        ...
        '#resume .resume-box h2': `Βιογραφικό`,
        '#resume .resume-box p:nth-of-type(1)': `Γεια! Είμαι ο <strong>Μιχαήλ Βότης</strong> και είμαι <strong>12 χρονών</strong>. Αγαπώ τη <span class="highlight-blue">ρομποτική</span> και τον <span class="highlight-gold">προγραμματισμό</span> από τότε που ήμουν 7 χρονών, και από τότε προσπαθώ συνέχεια να μαθαίνω καινούρια πράγματα.`,
        '#resume .resume-box p:nth-of-type(2)': `Δημιούργησα ένα μικρό <strong>κανάλι στο YouTube</strong>, το οποίο συνεχίζω να αναπτύσσω βήμα βήμα. Μου αρέσει πολύ ο προγραμματισμός και το web development, και το όνειρό μου είναι να γίνω <span class="highlight-blue">προγραμματιστής</span>.`,
        '#resume .resume-box p:nth-of-type(3)': `Μαθαίνω γλώσσες όπως <span class="highlight-gold">HTML</span>, <span class="highlight-blue">CSS</span>, JavaScript, Python, C++ και Java, ενώ πειραματίζομαι και με δημιουργικά εργαλεία όπως το <strong>DaVinci Resolve</strong>, το <strong>Photoshop</strong> και το <strong>Canva</strong>.`,
        '#resume .resume-box p:nth-of-type(4)': `Προσπαθώ πάντα να βελτιώνομαι, να δημιουργώ νέα projects και να μοιράζομαι τις ιδέες μου με άλλους.`,
        '#projects .section-title h2': `Projects`,
