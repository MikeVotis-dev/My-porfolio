  ...
  const translations = {
    ...
    el: {
      ...
      content: {
        ...
        '#resume .resume-box p:nth-child(1)': `Γεια! Είμαι ο <strong>Μιχαήλ Βώτης</strong> και είμαι <strong>12 χρονών</strong>. Αγαπώ τη <span class="highlight-blue">ρομποτική</span> και τον <span class="highlight-gold">προγραμματισμό</span> από τότε που ήμουν 7 χρονών, και από τότε προσπαθώ συνέχεια να μαθαίνω καινούρια πράγματα.`,
